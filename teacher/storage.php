            ...
            <div class="flex flex-col">
                <div class="bg-white shadow-md rounded-lg p-4 mb-4">
                    <div class="flex justify-between items-center mb-2">
                        ...
                        <button
                            class="bg-purple-100 text-purple-800 rounded-md text-sm p-2 cursor-pointer" onclick="linkPage('./instructional.php')">
                            สื่อการสอนของฉัน</button>
                    </div>
                    <hr class="border-0.5 border-gray-100 my-4 -mx-4">
                    <!-- table th -->
                                ...
                                for(let i = 0; i < 20; i++) {
                                    ...
                                    <div class="flex text-left text-sm text-gray-500 border-b border-gray-200 hover:bg-gray-50">
                                        ...
                                        <div class="w-1/5 flex justify-center">
                                            <button class="text-blue-500 hover:underline">See</button>
                                        </div>
                                    </div>
                                    `);
                                }
