        ...
        <div class="w-full md:w-1/3 ">
            <div class="border-2 border-purple-200 p-4 rounded-lg">
                <div class="">
                   ...
                   <p>
                       Workshop นี้มุ่งเน้นการถ่ายทอดความรู้ ทักษะ และเครื่องมือที่จำเป็นผ่านการลงมือปฏิบัติจริง เพื่อให้ผู้เข้าร่วมสามารถนำไปประยุกต์ใช้และสร้างผลลัพธ์ที่เป็นรูปธรรมได้ทันที            
                   </p>
                   <p>
                        ระยะเวลา : 3 ชั่วโมง
                   </p>
